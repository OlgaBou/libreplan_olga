...
public class PageProfils extends PageBandeau{
	...
	public void supprimerRole() throws Exception {
		WebElement iconePoubelle = driver.findElement(By.xpath("//tr[@class='z-row'][1]/td[@class='z-row-inner']//img"));
	...
	/*public void supprimerRole3() {
		WebDriverWait wait = new WebDriverWait(driver, 15);
		wait.until(ExpectedConditions.visibilityOf(iconePoubelle2));
		wait.until(ExpectedConditions.elementToBeClickable(iconePoubelle2));
		List<WebElement> elements = driver.findElements(By.xpath("//legend[@class='z-caption z-caption-readonly']/following-sibling::div//tr[@class='z-row']/td[@class='z-row-inner']//span[@class='icono z-button']"));
	...
	public void supprimerRole2() throws Exception {
		WebElement iconePoubelle = driver.findElement(By.xpath("//tr[@class='z-row z-row-over']/td[@class='z-row-inner']//img"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", iconePoubelle);
		Actions act=new Actions(driver);
		act.moveToElement(iconePoubelle).click().perform();
		saverEtContinuerButton.click();
